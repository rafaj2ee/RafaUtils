...
public class StringUtil {
    ...
    /**
     * Replace all Strings with TreeMap
     * key as what should be changed
     * value as what should it be
     */
    public static StringBuffer replaceAll(StringBuffer sb, TreeMap<String,String> tree, Character firstCharFrom, String firstStringTo) {
    	if(firstCharFrom!=null && firstStringTo!=null && sb.charAt(0)==firstCharFrom) {
    		sb.replace(0, firstStringTo.length(), firstStringTo);
    	}
