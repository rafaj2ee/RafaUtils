...
public class SourceFileSelector {
	...
	private boolean selectHtmlFiles = false;
    private boolean selectTxtFiles = false;
    /**
    ...
    public boolean isWantedFile(String fileName) {
        ...
        if (selectHtmlFiles
                && (extensionUppercase
                .equals(SourceFileConstants.HTM_UPPERCASE) || extensionUppercase
                .equals(SourceFileConstants.HTML_UPPERCASE))) {
            return true;
        }

        if (selectTxtFiles
                && (extensionUppercase
                .equals(SourceFileConstants.TXT_UPPERCASE) )) {
            return true;
        }
    ...
    public void setSelectHtmlFiles(boolean selectHtmlFiles) {
		this.selectHtmlFiles = selectHtmlFiles;
	}

	public void setSelectTxtFiles(boolean selectTxtFiles) {
		this.selectTxtFiles = selectTxtFiles;
	}
